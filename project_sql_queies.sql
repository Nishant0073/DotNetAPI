...
--                 @FirstName='Radha2', @LastName='Yadav', @Email='radh2a@redcross.org', @Gender='Female', @JobTitle='Sales Associate', @Department='Accounting', @Salary='158082.66', @Active='False', @UserId=0;
-- SELECT * FROM TutorialAppSchema.Users WHERE FirstName='Radha';
